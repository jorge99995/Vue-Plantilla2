     ...
     <div class="header">
            ...
            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src="assets/img/loguito.png" alt="Logo" >
                </a>
                <a href="index.html" class="logo logo-small">
                    <img src="assets/img/LOGO ESID-28.png" alt="Logo" width="30" height="30">
                </a>
            </div>
                ...
                <li class="nav-item dropdown noti-dropdown language-drop me-2">
                    ...
                    <div class="dropdown-menu ">
                        <div class="noti-content">
                            <div>
                                <a class="dropdown-item" href="javascript:void(0);"><i class="flag flag-lr me-2"></i>English</a>
